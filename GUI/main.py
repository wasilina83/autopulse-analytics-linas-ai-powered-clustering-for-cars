...
class SignalclassifierApp(App):
    ...
    # Define the OnfrequencyValueChange function outside of the on_play_button_click method
        ...
        self.setup_param_box = CustomLabel(text=f'Sätze deine Parameter', size_hint=(None, None), size=(int(Window.width*.625), int(Window.height*.06)), pos_hint={'center_x': 0.425, 'top': .8})
        self.setup_param_label = Label(text=f'Select a vehicle component and set parameters', size_hint=(None, None), size=(int(Window.width*.625), int(Window.height*.05)), pos_hint={'center_x': 0.425, 'top': 0.8}, color=utils.get_color_from_hex('#0046F0'), font_size='27sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
