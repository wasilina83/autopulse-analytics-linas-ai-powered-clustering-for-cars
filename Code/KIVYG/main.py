...
class SignalclassifierLayout(RelativeLayout):
    ...
    def refreshWindow(self, signal_type, duration, amplitude, frequency, offset, phase_shift):
        ...
        def __init__(self, **kwargs):
            ...
            # Laden des KV-Strings für das ImageUpdater-Layout
...
class SignalclassifierApp(App):
    ...
    def build(self):
        ...
        self.logo_pic = Image(source='KIVYG/images/logo.png', size_hint=(None, None), size=(logo_size*1.1, logo_size*1.1), pos_hint={'center_x': 0.49, 'top': 1.56})
        ...
        self.text_label3 = Label(text='Generator starten', font_size=int(window_height*.095), pos_hint={'center_x':.3, 'top': .65})
        ...
        self.play_button = Button(background_normal='KIVYG/images/play.png', size_hint=(None, None), size=(play_button_size, play_button_size), pos_hint={'center_x': 0.3, 'top': .56}, border=(0, 0, 0, 0))
    ...
    def on_play_button_click(self, instance):
        ...
        self.start_sig_box = SignalclassifierLayout(CustomLabel)
...
#         set_widgets_opacity_by_suffix(widget_dictb1, 0)
