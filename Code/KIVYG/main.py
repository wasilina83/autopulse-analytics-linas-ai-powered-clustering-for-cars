...
class SignalclassifierApp(App):
    ...
    # Define the OnfrequencyValueChange function outside of the on_play_button_click method
        ...
        self.setup_param_label = Label(text=f'Sätze die Parameter', size_hint=(None, None), size=(int(window_width*.25), int(window_height*.05)), pos_hint={'center_x': 0.2, 'top': 0.96}, color=(1, 1, 1, 1), font_size='16sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.layout.add_widget(self.setup_param_label)
        self.layout.add_widget(self.setup_param_box)
        self.start_sig_box = CustomLabel(text=f'Gererieren', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.3, 'top': 0.46}, color=(1, 1, 1, 1))
        self.start_sig = Label(text=f'Generieren', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.3, 'top': 0.45}, color=(1, 1, 1, 1), font_size='13sp',  font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.play_button2 = Button(background_normal='KIVYG/images/play.png', size_hint=(None, None), size=(window_height*.12, window_height*.12), pos_hint={'center_x': 0.3, 'top': 0.39}, border=(0, 0, 0, 0))
        ...
        self.setup_sig_label = Label(text=f'Wähle das Komponenze aus', size_hint=(None, None), size=(int(window_width*.25), int(window_height*.05)), pos_hint={'center_x': 0.2, 'top': 0.63}, color=(1, 1, 1, 1), font_size='13sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        ...
        #Zufals Signal
        self.rem_sig_label = Label(text=f'Zufals Signal', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.098, 'top': 0.358}, color=(1, 1, 1, 1), font_size='13sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.rem_sig_box = CustomLabel(text=f'zu sig', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.098, 'top': 0.358}, color=(1, 1, 1, 1))
        self.layout.add_widget(self.rem_sig_box)
        self.layout.add_widget(self.rem_sig_label)
        self.rem_button = Button(background_normal='KIVYG/images/rem.png', size_hint=(None, None), size=(window_height*.12, window_height*.12), pos_hint={'center_x': 0.16, 'top': 0.44}, border=(0, 0, 0, 0))
        self.rem_button.bind(on_press=self.on_rem_button_click)
        self.layout.add_widget(self.rem_button)
        #Richtiges Signal
        self.rig_sig_label = Label(text=f'Richtiges Signal', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.098, 'top': 0.25}, color=(1, 1, 1, 1), font_size='13sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.rig_sig_box = CustomLabel(text=f'sig', size_hint=(None, None), size=(int(window_width*.13), int(window_height*.1)), pos_hint={'center_x': 0.098, 'top': .25}, color=(1, 1, 1, 1))
        self.layout.add_widget(self.rig_sig_box)
        self.layout.add_widget(self.rig_sig_label)
        self.ok_button = Button(background_normal='KIVYG/images/uberprufen.png', size_hint=(None, None), size=(window_height*.12, window_height*.12), pos_hint={'center_x': 0.16, 'top': 0.3}, border=(0, 0, 0, 0))
