...
class SignalclassifierApp(App):
    ...
    def on_play_button_click(self, instance):
        ...
        self.setup_param_box = CustomLabel(text=f'Sätze die Parameter nach wunsch', size_hint=(None, None), size=(int(window_width*.35), int(window_height*.06)), pos_hint={'center_x': 0.2, 'top': .98}, color=(1, 1, 1, 1))
        ...
        self.setup_param_label = Label(text=f'Sätze die Parameter nach Wunsch', size_hint=(None, None), size=(int(window_width*.25), int(window_height*.05)), pos_hint={'center_x': 0.2, 'top': 0.98}, color=(1, 1, 1, 1), font_size='20sp', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
