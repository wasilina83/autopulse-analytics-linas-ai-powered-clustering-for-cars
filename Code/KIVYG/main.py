...
class SignalclassifierApp(App):
    ...
    def on_play_button_click(self, instance):
        ...
        self.amplitude_label = Label(text=f'Amplitude: {self.amplitude_slider.value}', size_hint=(None, None), size=(int(window_width*.25), int(window_height*.045)), pos_hint={'center_x': 0.2, 'top': 0.89}, color=(1, 1, 1, 1), font_size='11sp',font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.frequency_label = Label(text=f'Frequenz: {self.frequency_slider.value}', size_hint=(None, None), size=(int(window_width*.25), int(window_height*.045)), pos_hint={'center_x': 0.2, 'top': 0.76}, color=(1, 1, 1, 1), font_size='11sp',font_context='system://myapp', font_name='OpenSans-Bold.ttf')
    ...
    # Define the OnfrequencyValueChange function outside of the on_play_button_click method
        ...
        self.start_sig_box = CustomLabel(text=f'Signal gererieren', size_hint=(None, None), size=(int(window_width*.12), int(window_height*.07)), pos_hint={'center_x': 0.25, 'top': 0.44}, color=(1, 1, 1, 1))
        ...
        self.start_sig = Label(text=f'     Signal \ngenerieren', size_hint=(None, None), size=(int(window_width*.12), int(window_height*.07)), pos_hint={'center_x': 0.263, 'top': 0.44}, color=(1, 1, 1, 1), font_size='13sp',  font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        ...
        self.rem_button = Button(background_normal='KIVYG/images/wiederholen.png', size_hint=(None, None), size=(window_height*.12, window_height*.12), pos_hint={'center_x': 0.098, 'top': 0.33}, border=(0, 0, 0, 0))
        ...
        self.signal_type_spinner = Spinner(text='Lichtmaschine', values=signal_types, size_hint=(None, None), size=(int(window_width*.2), int(window_width*.045)), pos_hint={'center_x': 0.2, 'top': 0.59}, background_color=utils.get_color_from_hex('#0046F0'), outline_color=(0, 0.2745, 0.9412, 1), disabled_outline_color=(0, 0.2745, 0.9412, 1), color='white', font_context='system://myapp', font_name='OpenSans-Bold.ttf')
        self.layout.add_widget(self.signal_type_spinner)

        # Load the Play button
        self.play_button2 = Button(background_normal='KIVYG/images/play.png', size_hint=(None, None), size=(window_height*.12, window_height*.12), pos_hint={'center_x': 0.263, 'top': 0.33}, border=(0, 0, 0, 0))
